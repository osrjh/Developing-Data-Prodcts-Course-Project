...
* The output is a scatterplot with a prediction of miles per gallon calculated with the regression models. The sliders move the dependent prediction values.
